...
def plotDatapoints(stage2label_path, label_dst, sub_signature):
    ...
    stage2label_path = os.path.join(os.getcwd(), 'static', 'output', os.path.basename(stage2label_path))
    label_dst = os.path.join(os.getcwd(), 'static', 'output', os.path.basename(label_dst))
